...
type BillboardType int32

const (
	BillboardType_ONLINE  BillboardType = 0
	BillboardType_OFFLINE BillboardType = 1
)

var BillboardType_name = map[int32]string{
	0: "ONLINE",
	1: "OFFLINE",
}

var BillboardType_value = map[string]int32{
	"ONLINE":  0,
	"OFFLINE": 1,
}

func (x BillboardType) String() string {
	return proto.EnumName(BillboardType_name, int32(x))
}

func (BillboardType) EnumDescriptor() ([]byte, []int) {
...
type Billboard struct {
	...
	Type         BillboardType `protobuf:"varint,6,opt,name=type,proto3,enum=eeta.billboard.BillboardType" json:"type,omitempty"`
...
func (m *Billboard) GetType() BillboardType {
	if m != nil {
		return m.Type
	}
...
func init() {
	proto.RegisterEnum("eeta.billboard.BillboardType", BillboardType_name, BillboardType_value)
...
var fileDescriptor_ce86442ed919c461 = []byte{
	...
	,
}
...
func (m *Billboard) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x3a
	if m.Type != 0 {
		i = encodeVarintBillboard(dAtA, i, uint64(m.Type))
		i--
		dAtA[i] = 0x30
	}
	if len(m.Url) > 0 {
...
func (m *Billboard) Size() (n int) {
	...
	if m.Type != 0 {
		n += 1 + sovBillboard(uint64(m.Type))
	}
	l = m.MinPrice.Size()
	n += 1 + l + sovBillboard(uint64(l))
	return n
